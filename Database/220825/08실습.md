...
b = [a.id, a.name, a.debut, a. country]
c = ['id', 'name', 'debut', 'country']
...
for ii in i:
	print(ii.director, ii.genre, ii.title, ii.opening_date, ii.running_time,
          ii.screening)
```
...
```python
In [2]: i = Movie.objects.all()
   ...: for ii in i:
   ...:     print(ii.director.name, ii.genre, ii.title, ii.opening_date, ii.running_ 
   ...: time,ii.screening)
```
...
```python
In [3]: i = Movie.objects.all()
   ...: 
   ...: for ii in i:
   ...:     print(ii.director.name, ii.genre.title, ii.title, ii.opening_date, ii.ru 
   ...: nning_time,ii.screening)
```
...
```python
i = Movie.objects.order_by('-opening_date')

for ii in i:
     print(ii.director.name, ii.genre.title, ii.title, ii.opening_date, ii.running_time,ii.screening)
```
...
```python
i = Movie.objects.filter(screening = True).order_by('opening_date')

for ii in i:
	print(ii.director.name, ii.genre.title, ii.title, ii.opening_date,
          ii.running_time,ii.screening)
```
...
```python
director_ = Director.objects.get(name='봉준호')
i = Movie.objects.filter(director = director_).order_by('opening_date')
for ii in i:
	print(ii.director.name, ii.genre.title, ii.title, ii.opening_date,
          ii.running_time,ii.screening)
```
